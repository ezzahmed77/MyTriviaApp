...
import com.example.android.mytrivia.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
            ...
            if (checkedId != -1) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        setQuestion()
                        // Calling invalidate all to apply changes on UI
    ...
    private fun setQuestion() {
        ...
        // and shuffle them
        answers.shuffle()
        // Setting title of actionBar to current question
